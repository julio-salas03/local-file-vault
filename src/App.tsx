      ...
      <main class="px-5 py-8">
        <Tabs defaultValue="account">
          ...
          <TabsContent value="account">
            <div class="space-y-2">
              <h2 class="text-2xl font-semibold">Guest Mode</h2>
              <p>
                You can download shared files, but you can't upload your own.
              </p>
              <p>
                Click <strong>here</strong> to create an account or use the form
                below to login.
              </p>
            </div>
            <Separator class="my-5" />
